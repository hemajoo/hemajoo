...
/**
 * Exception thrown to indicate an error occurred with a localization service.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class LocalizationException extends HemajooException
{
    /**
     * Thrown to indicate that an error occurred with a localization service.
     *
