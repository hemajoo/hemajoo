 ...
 * -----------------------------------------------------------------------------------------------
 */
package com.hemajoo.i18n.translation.core.engine.azure;
...
public final class AzureTranslationEngine extends AbstractTranslationEngine
{
    /**
     ...
     */
    private static final String AZURE_TRANSLATE_API = "???";

    public AzureTranslationEngine()
    {
        super(TranslationProviderType.AZURE, AZURE_TRANSLATE_API, null);
    }

    public AzureTranslationEngine(ITranslation translation)
    {
        super(TranslationProviderType.AZURE, AZURE_TRANSLATE_API, translation);
    }
