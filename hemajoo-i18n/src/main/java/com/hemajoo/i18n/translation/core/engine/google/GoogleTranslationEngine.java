 ...
 * -----------------------------------------------------------------------------------------------
 */
package com.hemajoo.i18n.translation.core.engine.google;
...
public final class GoogleTranslationEngine extends AbstractTranslationEngine
{
    /**
    ...
    {
        super(TranslationProviderType.GOOGLE, GOOGLE_TRANSLATE_API, null);
    }

    public GoogleTranslationEngine(ITranslation translation)
    {
        super(TranslationProviderType.GOOGLE, GOOGLE_TRANSLATE_API, translation);
    }
